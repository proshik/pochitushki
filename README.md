...
**Бюджеты запросов.** На пользователя, окно в минуту: 60 сохранений ссылок,
20 генераций PDF, 3 импорта. Веб отвечает `429`, бот — сообщением. Хранятся в
памяти процесса, поэтому ограничитель на прокси они не заменяют.
